...
import {findAllTodos as findAllTodos_VAADIN_STUDIO_IMPORT_SUFFIX,saveTodo as saveTodo_VAADIN_STUDIO_IMPORT_SUFFIX} from 'Frontend/generated/TodoEndpoint';
import {customElement as customElement_VAADIN_STUDIO_IMPORT_SUFFIX,html as html_VAADIN_STUDIO_IMPORT_SUFFIX,state as state_VAADIN_STUDIO_IMPORT_SUFFIX} from 'lit-element';
import {View as View_VAADIN_STUDIO_IMPORT_SUFFIX} from './frontend/views/view';
import '@vaadin/vaadin-text-field';
import '@vaadin/vaadin-button';

var imports: string[] = [
  // Import insertion example: "'{showNotification} from @vaadin/flow-frontend/a-notification'"
  '{findAllTodos,saveTodo} from Frontend/generated/TodoEndpoint',
'{customElement,html,state} from lit-element',
'{View} from ../../views/view',
...
(window as any).importScope = {
  ...
  findAllTodos : findAllTodos_VAADIN_STUDIO_IMPORT_SUFFIX,
saveTodo : saveTodo_VAADIN_STUDIO_IMPORT_SUFFIX,
customElement : customElement_VAADIN_STUDIO_IMPORT_SUFFIX,
html : html_VAADIN_STUDIO_IMPORT_SUFFIX,
state : state_VAADIN_STUDIO_IMPORT_SUFFIX,
View : View_VAADIN_STUDIO_IMPORT_SUFFIX,
};
const importHeader = `
  // ImportHeader insertion example: "const showNotification = window.importScope.showNotification"
  const findAllTodos = window.importScope.findAllTodos;
const saveTodo = window.importScope.saveTodo;
const customElement = window.importScope.customElement;
const html = window.importScope.html;
const state = window.importScope.state;
const View = window.importScope.View;
`;
